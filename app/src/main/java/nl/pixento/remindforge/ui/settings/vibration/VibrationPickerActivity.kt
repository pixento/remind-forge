 ...
 * [nl.pixento.remindforge.ui.settings.SettingsViewModel], which reschedules the alarm chain after
...
class VibrationPickerActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val alertPlayer = (application as RemindForgeApplication).container.alertPlayer
